-- =============================================================================
-- fn_candidates_for_shift_block: return time_in / time_out so the modal can
-- show the full punch context on each excluded/exception row.
-- =============================================================================
-- Drop + recreate (can't change return shape with CREATE OR REPLACE).
-- =============================================================================
