...
// tagging it "Z" -- tagging local time as Z stored e.g. a 5:00am Central punch as
// 5:00am UTC (= midnight Central), shifting it earlier by the site's offset and
// breaking shift-block matching.
